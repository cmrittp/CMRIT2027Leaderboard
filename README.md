# CMRIT 2027 Batch AutoUpdating Leaderboard.

[![Java CI with Gradle](https://github.com/cmrittp/CMRIT2027Leaderboard/actions/workflows/gradle.yml/badge.svg)](https://github.com/cmrittp/CMRIT2027Leaderboard/actions/workflows/gradle.yml)

**The autoupdating leaderboard of CMR Institute of Technology, 2027 batch.**

**The scores of CMRIT 2027 Batch will automatically be mapped at https://cmrittp.github.io/CMRIT2027Leaderboard/ based on usernames from https://tinyurl.com/2027-batch-usernames**

**You can find my github account here : [gabyah92](https://github.com/gabyah92) and my Instagram over here : [gabyah92](https://www.instagram.com/gabyah92/)**
...
## Introduction
This project aims to create and maintain a leaderboard for participants from CMR Institute of Technology (CMRIT) for the year 2027. The leaderboard displays ratings and statistics of participants from various coding platforms such as Codeforces, LeetCode, GeeksforGeeks, Codechef, and Hackerrank.
...
```bash
git clone https://github.com/cmrittp/CMRITLeaderboard2027.git
```

If you have forked the Repo, replace `cmrittp` with your actual GitHub username. This will download the project's source code to your local machine.
...
* Ensure you have Java installed on your system for the `CMRITLeaderboard2027.java` file to execute successfully.
...
* **Jar Generation:** After executing `gradle build` in the previous step, a JAR file named `CMRIT2027Leaderboard-1.0-SNAPSHOT.jar` will be created within the `build/libs` directory.
...
```bash
java -jar CMRIT2027Leaderboard-1.0-SNAPSHOT.jar <options>
```
...
```bash
java -jar CMRIT2027Leaderboard-1.0-SNAPSHOT.jar codechef
```
...
```bash
java -jar CMRIT2027Leaderboard-1.0-SNAPSHOT.jar build_leaderboard
```
...
subgraph MainPage
    ...
    CurrentCMRITLeaderboard2027_xlsx(CurrentCMRITLeaderboard2027.xlsx) -.-> load_data
end
