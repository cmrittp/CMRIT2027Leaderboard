...
/**
 * The CMRITLeaderboard2027 class is responsible for scraping and processing data from various coding platforms
...
public class CMRITLeaderboard2027 {
    ...
    private static void buildLeaderboard(){
        ...
        try {
            ...
            try (FileOutputStream fileOut = new FileOutputStream("Leaderboards//CurrentCMRITLeaderboard2027.xlsx")) {
